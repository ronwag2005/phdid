...
to the oracle closes, and by `delta = 12` the ℓ₀ estimator essentially attains
...
Not on variance, but on inference. When the partition is uncertain, the ℓ₀
...
In the paper's full experiment, at low separation the ℓ₀ plug-in CATT coverage
...
correction to the ℓ₀ interval can replicate. Sample splitting does not rescue

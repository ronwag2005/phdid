...
3.5× in the paper's design and can misstate individual co-clustering
...
quantiles of noise. In the paper's second application the ℓ₀ estimator splits
...
common-effect χ² test, an excess-dispersion heterogeneity share, and the
...
> Arora, Parush and Rohan Wagle (2026). "Partial Homogeneity in Staggered
...
MIT © 2026 Rohan Wagle and Parush Arora. See [LICENSE.md](LICENSE.md).
